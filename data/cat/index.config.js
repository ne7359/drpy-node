...
var index_config_default = {
  drpyS: {
    ...
    // config_url: 'http://aqtm.leertai.top:5757/config/1?sub=all&pwd=qtm5869103', // 本地ds 支持
    // config_url: 'http://localhost:5707/config/0?sub=dzyyds', // 本地hipy-t4 支持
    home_site: "http://localhost:5757/api/设置中心",
    // home_site: 'http://aqtm.leertai.top:5757/api/设置中心',
    enable_dspush: 1,
    enable_home_site: 0,
    ...
    parse_timeout: 5e3,
    // 解析超时毫秒数
    test_thread_proxy: "http://aqtm.leertai.top:5759/proxy?thread=8&chunkSize=256&url=https://vdse.bdstatic.com//628ca08719cef5987ea2ae3c6f0d2386.mp4"
  },
  ffm3u8: {
  ...
  alist: [
    ...
    {
      "name": "🟢 碧云天",
      "server": "http://alist.dawnsummit.top:9999"
      // 不夜T4 http://alist.dawnsummit.top:9999/dsm7/docker/vodspider
    }
  ],
  color: [
    {
